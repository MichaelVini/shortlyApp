import React, { useState, Com, Component } from 'react';
...
class App extends Component {
  ...
  shorten = async () => {
    ...
    this.setState({ url: 'https://rel.ink/' + response.data.hashid });
          ...
          <section className="shorten">
            <div className="shorten">
              <div className="shorten-info">
                <input type="text" className="input" onInput={(e) => this.setState({ link: e.target.value })} />
                <button onClick={this.shorten}>Shorten It!</button>
              </div>
